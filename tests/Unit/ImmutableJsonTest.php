...
/**
 * @covers \Stratadox\Json\ImmutableJson
 ...
 */
class ImmutableJsonTest extends TestCase
{
    ...
    function retrieving_the_values_from_json(
        ...
        $json = ImmutableJson::fromString($jsonInput);
    ...
    function throwing_an_exception_when_the_json_input_is_invalid(
        ...
        ImmutableJson::fromString($invalidJson);
    }
    ...
    function formatting_the_object_as_string(
        ...
        $this->assertSame(
            $expectedOutput,
            (string) ImmutableJson::fromString($jsonInput)
        );
    }
    ...
    function retrieving_the_raw_data(string $jsonInput, $expectedData)
    {
        $this->assertSame(
            $expectedData,
            ImmutableJson::fromString($jsonInput)->data()
        );
    }
    ...
    function converting_raw_data_to_json(
        ...
        $this->assertSame(
            $expectedJson,
            (string) ImmutableJson::fromData($inputData)
        );
    }
    ...
    function throwing_an_exception_when_the_value_cannot_be_encoded_as_json(
        ...
        ImmutableJson::fromData($invalidInput);
    }
     ...
     * @dataProvider validJsonStringsWithAlterationsAndExpectations
     */
    function altering_the_json_structure_without_changing_the_original(
        string $jsonInput,
        array $changes
    ) {
        $original = ImmutableJson::fromString($jsonInput);
